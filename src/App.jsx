...
import image from "./groupbuysdao.gif";
...
const voteModule = sdk.getVoteModule(
  "0xA20442fcC7eA0FC37374ca34bE17B6C47D8ffFCc", //INSERT_YOUR_VOTE_MODULE_ADDRESS",
);
  ...
  if (!address) {
    return (
      <div className="landing">
        <h2>Group Buys DAO</h2>
        <h2>Free membership NFT $-)</h2>
        <img src={image} height={500} width={1000} />
        
        <button onClick={() => connectWallet("injected")} className="btn-hero">
          Connect your wallet to Rinkeby
        </button>
      </div>
    );
  }
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h1>GroupBuys.DAO Members</h1>
        <img src={image} height={500} width={1000} />
        
        <p>Congratulations on being a GB member</p>
        <div>
          <div>
            <h2>GB Member List</h2>
